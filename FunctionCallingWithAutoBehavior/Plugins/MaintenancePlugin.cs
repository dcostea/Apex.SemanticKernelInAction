...
public class MaintenancePlugin
{
    ...
    public async Task<string> CheckMotors()
    {
        ...
        Console.WriteLine($"[{DateTime.Now:mm:ss}] CHECKING motors. Status: {motorStatus}%");
        await Task.Delay(2000);
    ...
    public async Task<string> CheckTirePressure()
    {
        ...
        Console.WriteLine($"[{DateTime.Now:mm:ss}] CHECKING tire pressure: {pressure} PSI");
        await Task.Delay(2000);
    ...
    {
        Console.WriteLine($"[{DateTime.Now:mm:ss}] CLEANING solar panels...");
    ...
    public async Task<string> CheckBatteryHealth()
    {
        ...
        Console.WriteLine($"[{DateTime.Now:mm:ss}] CHECKING battery health: {batteryHealth}%");
        await Task.Delay(2000);
    ...
    {
        Console.WriteLine($"[{DateTime.Now:mm:ss}] UPDATING firmware...");
