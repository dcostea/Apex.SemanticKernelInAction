...
HandoffOrchestration orchestration = new(
            OrchestrationHandoffs
                .StartWith(meteoAgent)
                .Add(navigatorAgent, meteoAgent)
                //.Add(yodaAgent, dialogWriter, "Transfer to dialog writer to see what's next.")
                //.Add(jackSparrowAgent, dialogWriter, "Transfer to dialog writer to see what's next.")
                //.Add(shakespeareAgent, dialogWriter, "Transfer to dialog writer to see what's next.")
                //.Add(donQuijoteAgent, dialogWriter, "Transfer to dialog writer to see what's next."),
                .Add(meteoAgent, navigatorAgent),
            meteoAgent,
            navigatorAgent)
{
    InteractiveCallback = () =>
