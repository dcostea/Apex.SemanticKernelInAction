...
ChatCompletionAgent motorsAgent = new()
{
    ...
    Instructions = """
        ...
        Your ONLY responsibilities are to interpret mission commands, integrate safety data, and control the motors.
        The permitted basic moves are: forward, backward, turn left, turn right, and stop.
        
        # CRITICAL ACTIONS
        1. NEVER create safety reports. This is not your responsibility.
